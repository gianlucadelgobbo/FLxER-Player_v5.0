...
//
/*trace("tttttttttttttttttttttttttttt"+embeddedFontsArray[0].fontName)
trace("tttttttttttttttttttttttttttt"+embeddedFontsArray[1].fontName)
trace("tttttttttttttttttttttttttttt"+embeddedFontsArray[2].fontName)
trace("tttttttttttttttttttttttttttt"+embeddedFontsArray[3].fontName)*/
pref.tsHtml = new StyleSheet();
pref.tsHtml.setStyle("p",{fontFamily:embeddedFontsArray[1].fontName, fontSize:'8px', color:'#FFFFFF', marginLeft:'3px'});
