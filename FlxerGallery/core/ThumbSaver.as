...
&esito=1&nfile=".$_FILES["myfile"]["name"]."&  //se va tutto ok*/
		...
		function newThumb(t) {
			Preferences.pref.interfaceTrgt.myToolbar.myRemoveThumb2(null)
		}
		function rimuoviPuls(t) {
		}
		function scattaThumb(t) {
			bd.draw(Preferences.pref.interfaceTrgt.myMonitor);
		...
		function saveThumb(t) {
			...
			//
			var tmp = Preferences.pref.interfaceTrgt.myMonitor.currMov;
