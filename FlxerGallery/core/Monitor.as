package FlxerGallery.core {
	...
	public class Monitor extends Sprite {
		...
		public function Monitor() {
			...
			this.addChild(fondo);
			this.myPlayer = new Player(1,w,h,Preferences.pref.interfaceTrgt);
		...
		public function avvia(i) {
			...
			if (Preferences.pref.interfaceTrgt.myToolbar.hasEventListener(Event.ENTER_FRAME)) {
				Preferences.pref.interfaceTrgt.myToolbar.removeEventListener(Event.ENTER_FRAME, Preferences.pref.interfaceTrgt.myToolbar["indice_"+Preferences.pref.tipo]);
			}
			if (Preferences.pref.myFileList.childNodes[0].childNodes[i].attributes.type) {
				Preferences.pref.tipo = Preferences.pref.myFileList.childNodes[0].childNodes[i].attributes.type;
			} else {
				var tmp = Preferences.pref.myFileList.childNodes[0].childNodes[i].childNodes[0].childNodes[0].toString();
			...
			if (Preferences.pref.tipo == "png" || Preferences.pref.tipo == "gif" || Preferences.pref.tipo == "jpg") {
				...
				Preferences.pref.interfaceTrgt.myToolbar.piede.counter.lab.htmlText = listaSS.length+" / "+listaSS.length;
			} else {
				...
				Preferences.pref.interfaceTrgt.myToolbar.piede.counter.lab.htmlText = "00:00 / 00:00";
			}
			if (Preferences.pref.interfaceTrgt.myThumbLoader) {
				if(Preferences.pref.interfaceTrgt.contains(Preferences.pref.interfaceTrgt.myThumbLoader)){
					Preferences.pref.interfaceTrgt.removeChild(Preferences.pref.interfaceTrgt.myThumbLoader);
				}
			}
			Preferences.pref.interfaceTrgt.myToolbar.setPos();
			avviaCommon(i);
			this["avvia_"+Preferences.pref.tipo](index);
		}
		public function avviaCommon(i) {
			Preferences.pref.interfaceTrgt.myToolbar.avvia("player");
			resetta();
			this.visible = true;
			index = i;
			firstTime = true;
		...
		public function resetta() {
			//Preferences.pref.interfaceTrgt.myToolbar.resetta();
		...
		function avvia_swf(index) {
			swf_status = false;
			setLink(Preferences.pref.myFileList.childNodes[0].childNodes[index].attributes.page_url);
			var tmp = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[0].childNodes[0].toString();
			if (tmp.lastIndexOf("cnt=") != -1) {
				tmp = tmp.substring(tmp.lastIndexOf("cnt=")+4, tmp.length);
			}
			load_swf(tmp);
			//Preferences.pref.interfaceTrgt.myToolbar.tit = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[1].childNodes[0].toString();
			Preferences.pref.interfaceTrgt.myToolbar.tit = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[1].childNodes[0].childNodes[0].toString();
		...
		function avvia_txt(index) {
			setLink(Preferences.pref.myFileList.childNodes[0].childNodes[index].attributes.page_url);
			Preferences.pref.txtFile = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[0].childNodes[0].toString();
		...
		function load_txt(event) {
			mbuto(getTimer()+",loadMedia,0,"+Preferences.pref.txtSwfReader+",swf,100,"+Preferences.myReplace(myTxtLoader.data,",","###§###")+","+(Preferences.pref.ss_time/10));
		}
		/* MP3 /////////////////*/
		function avvia_mp3(index) {
			setLink(Preferences.pref.myFileList.childNodes[0].childNodes[index].attributes.page_url);
			currMov = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[0].childNodes[0].toString();
			var currThumb = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[2].childNodes[0].toString();
			mbuto(getTimer()+",loadMp3,0,"+currMov+","+Preferences.pref.tipo+","+(Preferences.pref.interfaceTrgt.myToolbar.piede.volume_ctrl.getVal()*100)+","+currThumb);
			//Preferences.pref.interfaceTrgt.myToolbar.tit = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[1].childNodes[0].toString();
			Preferences.pref.interfaceTrgt.myToolbar.tit = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[1].childNodes[0].childNodes[0].toString();
			Preferences.pref.interfaceTrgt.myToolbar.testa.lab_i.htmlText = Preferences.pref.interfaceTrgt.myToolbar.tit;
		}
		public function initHandlerMP3() {
			...
			Preferences.pref.interfaceTrgt.myToolbar.piede.contr.playpause.simb.gotoAndStop(2);
			Preferences.pref.interfaceTrgt.myToolbar.enable()
			Preferences.pref.interfaceTrgt.myToolbar.avvia_indice();
		}
		/* FLV /////////////////*/
		public function avvia_flv(index) {
			...
			//Preferences.pref.interfaceTrgt.myToolbar.tit = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[1].childNodes[0].toString();
			Preferences.pref.interfaceTrgt.myToolbar.tit = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[1].childNodes[0].childNodes[0].toString();
			Preferences.pref.interfaceTrgt.myToolbar.testa.lab_i.htmlText = Preferences.pref.interfaceTrgt.myToolbar.tit+": Buffering...";
			var tmp = Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[0].childNodes[0].toString();
			if (tmp.lastIndexOf("cnt=") != -1) {
				tmp = tmp.substring(tmp.lastIndexOf("cnt=")+4, tmp.length);
			}
			currMov = tmp;
			mbuto(getTimer()+",loadFlv,0,"+currMov+",flv,"+(Preferences.pref.interfaceTrgt.myToolbar.piede.volume_ctrl.getVal()*100));
		}
			...
			switch (event.info.code) {
				...
				case "NetStream.Play.Stop" :
					if (Preferences.pref.endpPath) {
						myPlayer.NS.seek(0);
						Preferences.pref.interfaceTrgt.myToolbar.myPlaypause(null);
						...
						if (Preferences.pref.myLoop) {
							...
							if (Preferences.pref.myFileList.childNodes[0].childNodes.length>1) {
								Preferences.pref.interfaceTrgt.myToolbar.avvia("selector");
							} else {
								myPlayer.NS.seek(0);
								Preferences.pref.interfaceTrgt.myToolbar.myPlaypause(null);
							}
		...
		function errorHandlerMess(event_type) {
			trace(event_type)
			Preferences.pref.interfaceTrgt.myToolbar.testa.lab_i.htmlText = Preferences.pref.interfaceTrgt.myToolbar.tit+": "+event_type;
			try {
		...
		function errorHandlerFLV(event) {
			...
			switch (event.info.code) {
				...
				case "NetStream.Play.StreamNotFound" :
					errorHandlerMess(Preferences.myReplace(event.info.code,"NetStream.Play.",""));
					break;
				case "NetStream.Play.NoSupportedTrackFound" :
					if (Preferences.pref.fpUpJsError) {
						Preferences.pref.interfaceTrgt.myToolbar.testa.lab_i.htmlText = Preferences.pref.interfaceTrgt.myToolbar.tit+": "+Preferences.myReplace(event.info.code,"NetStream.Play.","");
						try {
							if (ExternalInterface.available) {
		...
		function avvia_jpg(index) {
			for (var a = 0; a<listaSS.length; a++) {
				if (Preferences.pref.myFileList.childNodes[0].childNodes[index].childNodes[0].childNodes[0].toString() == Preferences.pref.myFileList.childNodes[0].childNodes[listaSS[a]].childNodes[0].childNodes[0].toString()) {
					index = a;
				}
			}
			if (index != undefined || index == 0) {
				...
				Preferences.pref.interfaceTrgt.myToolbar.mRoot.customItems[0].enabled = true;
			}
			//Preferences.pref.interfaceTrgt.myToolbar.piede.indice.curs.puls.enabled = false;
		...
		function loadNext() {
			if (Preferences.pref.tipo == "jpg" && listaSS.length>0 && !Preferences.pref.interfaceTrgt.myMonitor.myPlayer.myStopStatus) {
				load_foto();
			}
		}
		public function load_foto() {
			Preferences.pref.interfaceTrgt.myToolbar.disable()
			clearInterval(this.ssInt);
			setLink(Preferences.pref.myFileList.childNodes[0].childNodes[listaSS[n]].attributes.page_url);
			var tmp = Preferences.pref.myFileList.childNodes[0].childNodes[listaSS[n]].childNodes[0].childNodes[0].toString();
			if (tmp.lastIndexOf("cnt=") != -1) {
				tmp = tmp.substring(tmp.lastIndexOf("cnt=")+4, tmp.length);
			}
			currMov = tmp;
			mbuto(getTimer()+",loadImg,0,"+currMov+","+Preferences.pref.tipo+","+(Preferences.pref.interfaceTrgt.myToolbar.piede.volume_ctrl.getVal()*100));
			if (Preferences.pref.myFileList.childNodes[0].childNodes.length>1) {
				//Preferences.pref.interfaceTrgt.myToolbar.tit = (n+1)+" / "+listaSS.length+" - "+Preferences.pref.myFileList.childNodes[0].childNodes[listaSS[n]].childNodes[1].childNodes[0].childNodes[0].toString();
				Preferences.pref.interfaceTrgt.myToolbar.tit = Preferences.pref.myFileList.childNodes[0].childNodes[listaSS[n]].childNodes[1].childNodes[0].childNodes[0].toString();
		...
		function load_swf(mov) {
			currMov = mov;
			mbuto(getTimer()+",loadMedia,0,"+currMov+","+Preferences.pref.tipo+","+(Preferences.pref.interfaceTrgt.myToolbar.piede.volume_ctrl.getVal()*100));
		}
		function avviaSelector() {
			clearInterval(this.ssInt);
			Preferences.pref.interfaceTrgt.myToolbar.avviaSelector(null);
		}
		public function initHandlerSWF(trgt) {
			...
			if(trgt is flash.display.MovieClip) {
				Preferences.pref.interfaceTrgt.myToolbar.piede.contr.playpause.simb.gotoAndStop(2);
				Preferences.pref.interfaceTrgt.myToolbar.enable()
				Preferences.pref.interfaceTrgt.myToolbar.piede.volume_ctrl.disable();
				Preferences.pref.interfaceTrgt.myToolbar.avvia_indice();
			}
			//resizza();
		}
		...
		/*public function resizza_old(www=null,hhh=null) {
			...
			if (myPlayer.oldTipo) {
				...
				//navigateToURL(new URLRequest("javascript:alert('width "+tmpTrgt.width+"\\nheight "+tmpTrgt.height+"\\nPreferences.pref.interfaceTrgt.x "+tmpTrgt.Preferences.pref.interfaceTrgt.x+"\\nPreferences.pref.interfaceTrgt.y+ "+tmpTrgt.Preferences.pref.interfaceTrgt.y+"\\nx "+tmpTrgt.x+"\\ny "+tmpTrgt.y+"')"));
		}*/
